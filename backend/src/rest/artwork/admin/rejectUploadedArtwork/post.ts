...
const baseHandler = async (event): Promise<LambdaResponseToApiGw> => {
    ...
    await createNotification({
        body: 'Your upload did not meet the minimum quality requirements and has been deleted. You may upload another image during this period.',
        title: 'Upload rejected',
        type: 'message',
        userId: body.uploaderId
    }, DDBClient);
