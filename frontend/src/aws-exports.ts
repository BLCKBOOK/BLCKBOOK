...
// Written by aws-amplify-serverless-plugin/1.4.1 on 2021-09-06T09:46:29.928Z
...
const awsmobile: IAWSAmplifyConfiguration = {
    aws_cloud_logic_custom: [
        {
            endpoint: 'https://vndvizkdwb.execute-api.eu-west-1.amazonaws.com/dev',
    ...
    aws_user_pools_id: 'eu-west-1_hVBWpGFZI',
    aws_user_pools_web_client_id: '3te4lngr8bn1qmonkorv0v302s'
};
