...
// Written by aws-amplify-serverless-plugin/1.4.1 on 2021-09-06T08:16:33.431Z
...
const awsmobile: IAWSAmplifyConfiguration = {
    aws_cloud_logic_custom: [
        {
            endpoint: 'https://b7p56sw115.execute-api.eu-west-1.amazonaws.com/dev',
    ...
    aws_user_pools_id: 'eu-west-1_VjNyr2PDZ',
    aws_user_pools_web_client_id: '4squ3lhmfql9hbobtv8t0gbnal'
};
